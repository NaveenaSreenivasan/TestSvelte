...
var arrcheck = writable(["aaa","bbb","ccc","ddd","eee"]);
const col = writable([]);

var storeArr = writable(["Alpha","Beta","Gamma"]);
...
const Checkcode = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `<title>Check code</title>`, "")}
	$storeArr
	<button>Change arr</button>`;
});

/* src/routes/about.svelte generated by Svelte v3.6.3 */

const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let $arrcheck = get_store_value(arrcheck), $col = get_store_value(col);

	return `



	${($$result.head += `<title>About</title>`, "")}

	<h1>About this site</h1>

	<p>This is the 'about' page. There's not much here.</p>

	 ${each($arrcheck, (val, i) => `<h3> ${escape(val)} </h3>`)}
	<h3> ${escape($arrcheck.length)} </h3>
	...
	<button>Push</button>
	<ol>
	  ${each($col, (item) => `<li>${escape(item)}</li>`)}
	</ol>`;
});

/* src/routes/blog/index.svelte generated by Svelte v3.6.3 */
...
/* src/routes/blog/[slug].svelte generated by Svelte v3.6.3 */
...
/* src/components/Nav.svelte generated by Svelte v3.6.3 */
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-11kwxiv">
		<ul class="svelte-11kwxiv">
			...
			<li class="svelte-11kwxiv"><a class="${escape(segment === "about" ? "selected" : "")} svelte-11kwxiv" href="about">about</a></li>
			<li class="svelte-11kwxiv"><a class="${escape(segment === "checkcode" ? "selected" : "")} svelte-11kwxiv" href="checkcode">Check</a></li>


			<li class="svelte-11kwxiv"><a rel="prefetch" class="${escape(segment === "blog" ? "selected" : "")} svelte-11kwxiv" href="blog">blog</a></li>
		</ul>
	</nav>`;
});

/* src/routes/_layout.svelte generated by Svelte v3.6.3 */
...
/* src/routes/_error.svelte generated by Svelte v3.6.3 */
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/checkcode\/?$/,
			parts: [
				{ name: "checkcode", file: "checkcode.svelte", component: Checkcode }
			]
		},
...
/* src/node_modules/@sapper/internal/App.svelte generated by Svelte v3.6.3 */
